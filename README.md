...
**Aktuális firmware verzió:** `7.8.6` (2026-06-06)
...
A projekt **Seeed XIAO ESP32-C3**-ra fordul, **ESP32 Arduino core 3.1.3**-mal és a
**OneButton** könyvtárral, a `partitions_custom.csv` custom partícióval.
...
> (az `app0` mérete, 0x150000) build-property-kkel fordít. A sketch kb. **83%**-on
> áll (≈1.15 MB / 1.375 MB). Feltöltéshez a XIAO bootloader-gomb + soros port kell
> (a webes környezet csak fordít, nem flashel).
